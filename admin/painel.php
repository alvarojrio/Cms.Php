    ...
    <body class="painel">
        ...
        <header id="navadmin">
            <div class="content">
                ...
                <h1 class="logomarca">Painel Admin</h1>
                ...
                <nav>
                    <h1><a href="painel.php" title="Dasboard">Estasticas</a></h1>
                    ...
                    <ul class="menu">
                        <li class="li<?php if (in_array('posts', $linkto)) echo ' active'; ?>"><a class="opensub" onclick="return false;" href="#">Cadastra Produtos</a>
                            <ul class="sub">
                                <li><a href="painel.php?exe=posts/create">Adicionar produto</a></li>
