...
define('SITEDESC', 'Este site foi desenvolvido para vaga de programador utlizando  PHP Orientado a Objetos da .Utlizei  a arquitetura semântica do HTML5 e últimas técnologias disponíveis!');

// DEFINE A BASE DO SITE ####################
define('HOME', 'http://localhost/projeto');
define('THEME', 'online');
